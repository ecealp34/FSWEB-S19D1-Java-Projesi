...
public class HollywoodExceptions {
    ...
    public ResponseEntity<HollywoodErrorResponse> handleException(MovieException exception) {
        HollywoodErrorResponse response = new HollywoodErrorResponse(exception.getCode().value(), exception.getMessage(), System.currentTimeMillis());
    ...
    public ResponseEntity<HollywoodErrorResponse> handleException(Exception exception) {
        ...
        HollywoodErrorResponse response = new HollywoodErrorResponse(HttpStatus.BAD_REQUEST.value(), exception.getMessage(), System.currentTimeMillis());
